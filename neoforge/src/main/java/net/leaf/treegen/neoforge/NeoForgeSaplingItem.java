...
/**
 * Builds and reads the "magical" sapling item handed out by {@code /leaftree give} on NeoForge.
 *
 ...
 * and lets {@link NeoForgeSaplingListener} recognise it when planted and grow the right species,
 * mirroring the Paper platform's persistent-data-container approach.
 */
final class NeoForgeSaplingItem {
